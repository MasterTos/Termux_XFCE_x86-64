...
```
curl -sL https://raw.githubusercontent.com/MasterTos/Termux_XFCE_x86-64/main/install_xfce_native.sh -o install_xfce_native.sh && chmod +x install_xfce_native.sh && ./install_xfce_native.sh
```
&nbsp;
